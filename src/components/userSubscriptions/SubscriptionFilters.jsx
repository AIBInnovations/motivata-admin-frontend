...
import { SUBSCRIPTION_STATUS, SORT_OPTIONS } from '../../hooks/useUserSubscriptions';
import serviceService from '../../services/service.service';

/**
 * SubscriptionFilters Component
 * Provides search and filter controls for subscriptions list
 */
function SubscriptionFilters({
  ...
  useEffect(() => {
    const fetchServices = async () => {
      try {
        const result = await serviceService.getAll({ limit: 100 });
        if (result.success) {
